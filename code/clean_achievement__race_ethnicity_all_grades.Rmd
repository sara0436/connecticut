...
subtitle: "CT EdSight Data - Smarter Balanced Achievement, Race/Ethnicity, All Grades"
...
df_school <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_race_ethnicity_all_grades_SCHOOL.csv"),
               skip = 6, na = c("*"), col_names = c("district", "district code", "school", "school code", "subject",
                                                    "race_ethnicity", "201516_num", "201516_pct",
...
# Load data
df_district <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_race_ethnicity_all_grades.csv"),
...
df_state <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_race_ethnicity_all_grades_STATE.csv"),
...
df %>%
  get_dupes(school_year, district_name, school_name, subject, race_ethnicity)
```
...
```{r}
df %>% saveRDS(here("data/clean/smarterbalanced_achievement_race_ethnicity_all_grades.rds"))
```
