...
subtitle: "CT EdSight Data - Enrollment, SWD Students"
...
```{r}
# Load data
df <- read_excel(here("data/raw/enrollment/CT_enrollment_data_SWD_students_SCHOOL.xlsx"),
...
df <- df %>%
  ...
  rename(special_education_status = student_group)
```
...
```{r}
df %>% saveRDS(here("data/clean/enrollment/enrollment_SWD.rds"))
```
