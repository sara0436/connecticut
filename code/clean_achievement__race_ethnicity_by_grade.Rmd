...
subtitle: "CT EdSight Data - Smarter Balanced Achievement, Race/Ethnicity by Grade"
...
df_school <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_race_ethnicity_by_grade_SCHOOL.csv"),
...
df_district <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_race_ethnicity_by_grade.csv"),
...
df_state <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_race_ethnicity_by_grade_STATE.csv"),
...
df <- df %>% 
  pivot_longer(
    cols = !(district_name:race_ethnicity),
...
df %>%
  get_dupes(school_year, district_name, school_name, subject, grade, race_ethnicity)
```
...
```{r}
df %>% saveRDS(here("data/clean/smarterbalanced_achievement_race_ethnicity_by_grade.rds"))
```
