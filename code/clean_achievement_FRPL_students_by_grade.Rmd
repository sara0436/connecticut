...
subtitle: "CT EdSight Data - Smarter Balanced Achievement, FRPL Students by Grade"
...
df_school <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_FRPL_students_by_grade_SCHOOL.csv"),
...
df_district <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_FRPL_students_by_grade.csv"),
...
df_state <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_FRPL_students_by_grade_STATE.csv"),
...
df <- df %>% 
  pivot_longer(
    cols = !(district_name:free_reduced_lunch_3_levels),
...
# free_reduced_lunch_3_levels
df <- df %>%
  mutate(free_reduced_lunch_3_levels = case_when(free_reduced_lunch_3_levels == "F" ~ "Eligible for Free Meals",
                                                 free_reduced_lunch_3_levels == "R" ~ "Eligible for Reduced-Price Meals",
                                                 free_reduced_lunch_3_levels == "N" ~ "Not Eligible",
                                                 TRUE ~ NA)) %>% 
...
df %>%
  get_dupes(school_year, district_name, school_year, subject, grade, free_reduced_lunch_3_levels)
```
...
```{r}
df %>% saveRDS(here("data/clean/smarterbalanced_achievement/smarterbalanced_achievement_FRPL_students_by_grade.rds"))
```
