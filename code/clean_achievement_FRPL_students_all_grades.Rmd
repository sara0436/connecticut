...
subtitle: "CT EdSight Data - Smarter Balanced Achievement, FRPL Students, All Grades"
...
df_school <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_FRPL_students_all_grades_SCHOOL.csv"),
               skip = 6, na = c("*"), col_names = c("district", "district code", "school", "school code", "subject",
                                                    "free_reduced_lunch_3_levels", "201516_num", "201516_pct",
...
df_district <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_FRPL_students_all_grades.csv"),
...
df_state <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_FRPL_students_all_grades_STATE.csv"),
...
# free_reduced_price_lunch_eligibility
df <- df %>%
...
df %>%
  get_dupes(school_year, district_name, school_name, subject, free_reduced_lunch_3_levels)
```
...
```{r}
df %>% saveRDS(here("data/clean/smarterbalanced_achievement/smarterbalanced_achievement_FRPL_students_all_grades.rds"))
```
