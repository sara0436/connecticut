...
subtitle: "CT EdSight Data - Enrollment, ELL Students"
...
```{r}
# Load data
df <- read_excel(here("data/raw/enrollment/CT_enrollment_data_ELL_students_SCHOOL.xlsx"),
...
df <- df %>%
  ...
  rename(english_learner_status = student_group)
```
...
```{r}
df %>% saveRDS(here("data/clean/enrollment/enrollment_ELL.rds"))
```
