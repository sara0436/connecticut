...
subtitle: "CT EdSight Data - Smarter Balanced Achievement, All Students"
...
pacman::p_load_gh("tntp/tntpr")
```

# Load Data
```{r}
# Load data - school level
df_school <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_all_students_all_grades_SCHOOL.csv"),
               skip = 6, na = c("*"), col_names = c("district", "district code", "school", "school code", "subject", "201516_num",
               "201516_pct", "201617_num", "201617_pct", "201718_num", "201718_pct",
               "201819_num", "201819_pct", "202122_num", "202122_pct", "202223_num", "202223_pct")) %>% 
  clean_names %>%
...
df_district <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_all_students_all_grades.csv"),
               skip = 6, na = c("*"), col_names = c("district", "district code", "subject", "201516_num",
               "201516_pct", "201617_num", "201617_pct", "201718_num", "201718_pct",
               "201819_num", "201819_pct", "202122_num", "202122_pct", "202223_num", "202223_pct")) %>% 
  clean_names %>%
...
df_state <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_all_students_all_grades_STATE.csv"),
               skip = 6, na = c("*"), col_names = c("district", "subject", "201516_num",
               "201516_pct", "201617_num", "201617_pct", "201718_num", "201718_pct",
               "201819_num", "201819_pct", "202122_num", "202122_pct", "202223_num", "202223_pct")) %>% 
  clean_names %>%
  rename(district_name = district) %>% 
...
df %>%
  get_dupes(school_year, district_name, school_name, subject)
```
...
```{r}
df %>% saveRDS(here("data/clean/smarterbalanced_achievement/smarterbalanced_achievement_all_students.rds"))
```