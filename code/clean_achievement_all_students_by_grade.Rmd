...
subtitle: "CT EdSight Data - Smarter Balanced Achievement, All Students by Grade"
...
df_school <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_all_students_by_grade_SCHOOL.csv"),
...
df_district <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_all_students_by_grade.csv"),
...
df_state <- read_csv(here("data/raw/smarterbalanced_achievement/CT_smarterbalanced_achievement_all_students_by_grade_STATE.csv"),
...
df %>%
  get_dupes(school_year, district_name, school_name, subject, grade)
```
...
```{r}
df %>% saveRDS(here("data/clean/smarterbalanced_achievement/smarterbalanced_achievement_all_students_by_grade.rds"))
```
